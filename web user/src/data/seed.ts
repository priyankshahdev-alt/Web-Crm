  ...
  const approvals: ApprovalRequest[] = [
    {
      ...
      resourceId: 'p1',
      resourceType: 'page',
      resourceTitle: 'Publish "Women Empowerment" program page',
      action: 'publish',
      status: 'PENDING',
      submitterNote: 'Content has been reviewed internally, please publish.',
      submitterId: null,
      reviewerId: null,
      submittedAt: ago(0.3),
      ...
      updatedAt: ago(0.3),
      events: [
        { id: 'at1', requestId: 'ap1', actorName: 'Kavita Rao', actorId: null, action: 'SUBMITTED', note: 'Moved program page to pending.', createdAt: ago(0.3) },
      ],
    },
    {
      id: 'ap2',
      ...
      resourceId: 'b1',
      resourceType: 'blog',
      resourceTitle: 'Publish blog "Volunteer Spotlight: Priya"',
      action: 'publish',
      status: 'PENDING',
      submitterNote: null,
      submitterId: null,
      ...
      updatedAt: ago(1.1),
      events: [
        { id: 'at2', requestId: 'ap2', actorName: 'Ananya Sharma', actorId: null, action: 'SUBMITTED', note: null, createdAt: ago(1.1) },
      ],
    },
    {
      id: 'ap3',
      ...
      resourceId: 's1',
      resourceType: 'page',
      resourceTitle: 'Update website primary color to #5B4CF0',
      action: 'publish',
      status: 'APPROVED',
      submitterNote: 'Please update the brand color.',
      reviewerNote: 'LGTM, applied.',
      submitterId: null,
      reviewerId: null,
      submittedAt: ago(2.4),
      reviewedAt: ago(1.8),
      ...
      updatedAt: ago(1.8),
      events: [
        { id: 'at3', requestId: 'ap3', actorName: 'Kavita Rao', actorId: null, action: 'SUBMITTED', note: null, createdAt: ago(2.4) },
        { id: 'at4', requestId: 'ap3', actorName: 'Rahul Mehta', actorId: null, action: 'APPROVED', note: 'LGTM, applied.', createdAt: ago(1.8) },
      ],
    },
  ]
